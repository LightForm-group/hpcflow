...
def dummy_make_something(name, num):
    for i in range(num):
        out_path = Path('{}_{}'.format(name, i))
        with out_path.open('w') as handle:
            handle.write('{}\n'.format(randint(0, 1e6)))
            handle.write('{} Generated by `makeSomething --name {} --num {}`.'.format(
                datetime.now(), name, num
            ))
...
def dummy_do_something(infile1, infile2):
    ...
    out_path = Path('outfile.txt')
    with out_path.open('w') as handle:
        handle.write('{}\n'.format(randint(0, 1e6)))
        handle.write('{} Generated by `doSomething --infile1 {} --infile2 {}`.\n'.format(
            datetime.now(), infile1, infile2))
        handle.write('{} Original file ID: {}: {}\n'.format(
            datetime.now(), infile1, file_id_1))
        handle.write('{} Original file ID: {}: {}\n'.format(
            datetime.now(), infile2, file_id_2))
